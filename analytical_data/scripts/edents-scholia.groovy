...
*/
String usage = "Usage: groovy edents-scholia.groovy EdentsFile ScholiaFile"
...
println "#Comparing paragraphs with scholia"
println "Number of lines with **paragraphs** (edents): " + list1.size() + "\n"
println "Number of items with **scholia**: " + list2.size() + "\n"
println "Number of common items: " + ldiff.lcs.size() + "\n"

println "Key:"
println "- {++paragraph with no scholia++}"
